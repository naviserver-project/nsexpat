...
NS_EXTERN int TclExpatObjCmd _ANSI_ARGS_((ClientData dummy, Tcl_Interp * interp, int objc, Tcl_Obj * CONST objv[]));
NS_EXTERN int CheckExpatParserObj _ANSI_ARGS_((Tcl_Interp * interp, Tcl_Obj * CONST nameObj));
NS_EXTERN int CHandlerSetInstall _ANSI_ARGS_((Tcl_Interp * interp, Tcl_Obj * CONST expatObj, CHandlerSet * handlerSet));
NS_EXTERN int CHandlerSetRemove _ANSI_ARGS_((Tcl_Interp * interp, Tcl_Obj * CONST expatObj, char *handlerSetName));
NS_EXTERN CHandlerSet *CHandlerSetCreate _ANSI_ARGS_((char *name));
NS_EXTERN CHandlerSet *CHandlerSetGet _ANSI_ARGS_((Tcl_Interp * interp, Tcl_Obj * CONST expatObj, char *handlerSetName));
NS_EXTERN void *CHandlerSetGetUserData _ANSI_ARGS_((Tcl_Interp * interp, Tcl_Obj * CONST expatObj, char *handlerSetName));
NS_EXTERN TclGenExpatInfo *GetExpatInfo _ANSI_ARGS_((Tcl_Interp * interp, Tcl_Obj * CONST expatObj));
